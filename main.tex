...
\begin{center}
    ...
    Affin d'étudier les systèmes d'exploitations temps réel compatibles avec la carte de développement qui m'a été fourni, je me suis d'abord familiariser avec celle-ci avant d'en étudier la compatibilité avec des systèmes très complexes.
