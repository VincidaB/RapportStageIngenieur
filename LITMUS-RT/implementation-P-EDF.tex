...
\begin{lstlisting}[style=makefilestyle, escapechar=\%]
#
...
On place notre fichier à compiler sous mot clé \texttt{obj-y} pour signifier que l'on veut ce module compilé et inclus lors de la compilation du noyau Linux.
